...
int main()
{
  vector<vector<float> > features1, features2, features3;
  loadFeaturesPerImage(features1, "images/image1.png");
  loadFeaturesPerImage(features2, "images/image2.png");
  loadFeaturesPerImage(features3, "images/image3.png");

  vector<vector<vector<float> > > node1, node2, node3;

  node1.push_back(features1);
  node1.push_back(features2);
  node1.push_back(features3);

  node2.push_back(features2);
  node2.push_back(features1);
  node2.push_back(features3);

  node3.push_back(features3);
  node3.push_back(features1);
  node3.push_back(features2);

  testVocCreation(node1, "voc1.yml.gz");
  testVocCreation(node2, "voc2.yml.gz");
  testVocCreation(node3, "voc3.yml.gz");
